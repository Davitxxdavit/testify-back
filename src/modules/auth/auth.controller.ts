...
export class AuthController {
  ...
  @Post('staff/login')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Login as staff' })
  @ApiResponse({ status: 200, description: 'Staff login successful', type: AuthResponseDto })
  async staffLogin(@Body() loginDto: LoginDto): Promise<AuthResponseDto> {
