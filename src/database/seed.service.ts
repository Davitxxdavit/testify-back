...
export class SeedService implements OnModuleInit {
    ...
    private async seedAdminUser() {
        ...
        const adminEmail = 'admin@tastify.com';
    ...
    private async seedMenuData() {
        ...
        this.logger.log(`   - ${burgers.id} Burgers category with 4 items`);
        this.logger.log(`   - ${sides.id} Sides category with 2 items`);
        this.logger.log(`   - ${drinks.id} Drinks category with 2 items`);
    }
}
